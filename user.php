        	      ...
        	      $sqlmember ="SELECT * FROM tbl_users WHERE State!='Super'";
			       $retrieve = mysqli_query($db,$sqlmember);
                     ...
                     while($found = mysqli_fetch_array($retrieve))
	                 {
                       ...
                       $id=$found['id'];$online=$found['Online'];$role=$found['Role'];$picname=$found['Pic_name'];$emails=$found['Email'];
				...
				break;
				   ...
				   elseif(!isset($suffix)) { $lseen=$count." ago ";}
			           ...
			           echo"<tr>                                           
			                 ...
			                 <td>$lseen</td>
			                 <td>
			                <a data-toggle='modal' data-p1='$adduser' data-p2='$manageuser' data-p3='$logact' data-p4='$addpat' data-p5='$editpat' data-p6='$managepat' data-p7='$tripatient' data-id='$id' data-ik='$names' href='#Privilages' class='open-Privilages btn  btn-primary' title='Click here to add/change user privilages'><span class='glyphicon glyphicon-check' style='color:white;' ></span></a>
							 ...
							 <td>
                              <a data-toggle='modal' data-id='$id' data-p1='$firstname' data-p2='$sirname' data-p3='$title' data-p4='$picname' data-p5='$phones' data-p6='$emails' data-p7='$role'   class='open-Edituser btn btn-primary' title='modifier utilisateur' href='#Modifie_user'>
