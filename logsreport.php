                        ...
                        if( mysqli_num_rows($result) != 0)                         
                         {
			                 ...
			                 <td>$number</td>			               
			                 <td>
                              <a  data-toggle='modal' href='#displaydrug' data-ia='$strin' data-id='$uname' data-ie='$number'   data-if='$ip' data-ig='$logintime' data-ih='$logouttime' data-ij='Dr Y B Mlombe Pvt Clinic' data-ik='$position' class='open-Passwordss btn  btn-success' title='Click here to view user all drug record'><span class='glyphicon glyphicon-eye-open' style='color:white;' ></span></a>
