...
$retrieved = mysqli_query($db,$sqluser);
				...
				<div class='middle-content'>
					...
					<!-- start content_slider -->
				         <div class='alert alert-info'>
                             <i class='fa fa-info'></i>&nbsp;Use the form below to complete patients details
                         </div>
    ...
    <span class='input-group-addon' >First Name &nbsp &nbsp &nbsp</span>
   <input type='text' name='fname' placeholder='Enter First Name' value='' class='form-control' >
       </div>
       <div class='input-group' style='margin-bottom:10px;'>
       <span class='input-group-addon'>Other Name &nbsp &nbsp</span>
   <input type='text' name='mname' placeholder='Other name'  value='' class='form-control'   value=''  >
 </div>
 <div class='input-group' style='margin-bottom:10px;'>
    <span class='input-group-addon'>Last Name &nbsp &nbsp &nbsp</span>
  ...
  <div class='input-group' style='margin-bottom:10px; '>
    <span class='input-group-addon'>Date of Birth &nbsp</span>
   <input type='date'  name='dob' class='form-control' value='' >
					...
					<div class='col-md-4 charts-grids widget states-mdl'>
						<div class='card-header' style='font-weight: bold; font-family: 'Palatino Linotype', serif'>
							<h3>Trusted Person</h3>
						</div>
				
  
     <div class='input-group' style='margin-bottom:15px;margin-top:15px;'>
      <span class='input-group-addon'>Village &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp</span>
   <input type='text' name='village' placeholder='Residential area' class='form-control' value=''  >
  </div>	
  <div class='input-group' style='margin-bottom:16px;'>
    <span class='input-group-addon'>Next of Kin &nbsp &nbsp &nbsp &nbsp &nbsp</span>
     <input type='text' name='guardian' placeholder='Enter Guardian' class='form-control' value=''>
     </div>
     <div class='input-group' style='margin-bottom:16px;'>
          <span class='input-group-addon'>Relationship &nbsp &nbsp &nbsp &nbsp</span>
  ...
  <div class='input-group' style='margin-bottom:16px;'>
      <span class='input-group-addon'>Patient Phone &nbsp &nbsp &nbsp  </span>
...
<div class='modal-footer'>
      	...
      	<input type='submit' class='btn btn-success'  id='btns10' value='Send HL7 message' name='submitedd3'> &nbsp;
